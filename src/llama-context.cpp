...
llama_context::llama_context(
    ...
    LLAMA_LOG_INFO("%s: enable_pipo   = %s\n",   __func__, cparams.enable_pipo ? "true" : "false");
    LLAMA_LOG_INFO("%s: n_cpu_layers_per_split      = %u\n",   __func__, cparams.n_cpu_layers_per_split);
